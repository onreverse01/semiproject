 ...
 */
@WebServlet("/board/adminBoardUpdate")
public class AdminBoardUpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//3. 이동
		request.getRequestDispatcher("/WEB-INF/views/board/adminBoardUpdate.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = 0;
		result = boardService.updateAdminBoard(board);
		...
		board = boardService.selectAdminBoardOne(boardNo);
		request.setAttribute("board", board);
