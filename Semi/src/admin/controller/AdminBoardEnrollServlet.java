...
/**
 * Servlet implementation class AdminBoardEnroll
 */
@WebServlet("/board/adminBoardEnroll")
public class AdminBoardEnrollServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/views/board/adminBoardEnroll.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = 0;
		result=boardService.insertAdminBoard(b);
		if(result > 0) {
