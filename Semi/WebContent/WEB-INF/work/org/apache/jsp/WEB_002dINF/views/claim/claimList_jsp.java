 ...
 * Generated at: 2021-04-27 09:39:05 UTC
...
public final class claimList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("claim.model.vo.AnwBoard");
    _jspx_imports_classes.add("java.util.List");
    _jspx_imports_classes.add("member.model.vo.Member");
    _jspx_imports_classes.add("claim.model.vo.ClaimBoard");
  }
...
if(loginMember==null){
      ...
      out.write("        </ul>\r\n");
      out.write("    </div>\r\n");
      out.write("   \t<div class=\"claimList\">\r\n");
      out.write("       <table class=\"cList\">\r\n");
      out.write("           <tr class=\"cListh\">\r\n");
      out.write("               <th>No</th>\r\n");
      out.write("               <th>문의채널</th>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t<tr class=\"cListb\">\r\n");
      out.write("\t\t\t<td>");
      out.print( list.get(i).getNo() );
      out.write("</td>\r\n");
      out.write("\t\t\t<td>");
      out.print( list.get(i).getChoice() );
      out.write("</td>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<a href=\"");
      out.print( request.getContextPath() );
      out.write("/claim/claimView?no=");
      out.print( list.get(i).getNo() );
      out.write('"');
      out.write('>');
 ...
 if(!(alist.isEmpty())&&(list.get(i).getNo() == alist.get(i).getNo())) {
      out.write("\r\n");
      out.write("\t\t\t\t<td>");
      out.print( alist.get(i).getRegDate() == null ? "대기중" : alist.get(i).getRegDate() );
      out.write("</td>\r\n");
      out.write("\t\t\t");
 } 
      out.write("\r\n");
 ...
 if(!(alist.isEmpty())&&!(alist.get(i).getContent()==null)) {
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<td><input type=\"button\" value=\"답변하기\" onclick=\"location.href='");
      out.print( request.getContextPath() );
      out.write("/claim/answer?no=");
      out.print( list.get(i).getNo() );
      out.write("'\"></td>\r\n");
      out.write("\t\t\t");
 } 
 ...
 if(!(alist.isEmpty())&&!(alist.get(i).getContent()==null)&&list.get(i).getNo() == alist.get(i).getNo()) {
      ...
      out.write("\t\t<tr class=\"cListb\">\r\n");
      out.write("\t\t\t<td>");
      out.print( wlist.get(i).getRnum() );
      out.write("</td>\r\n");
      out.write("\t\t\t<td>");
      out.print( wlist.get(i).getChoice() );
      out.write("</td>\r\n");
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t<a href=\"");
      out.print( request.getContextPath() );
      out.write("/claim/claimView?no=");
      out.print( wlist.get(i).getNo() );
      out.write('"');
      out.write('>');
      out.print( wlist.get(i).getTitle() );
      out.write("</a>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<td>");
      out.print( wlist.get(i).getRegDate() );
      out.write("</td>\r\n");
      out.write("\t\t\t");
 if(!(walist.isEmpty())&&(wlist.get(i).getNo() == walist.get(i).getNo())) {
      out.write("\r\n");
      out.write("\t\t\t\t<td>");
      out.print( walist.get(i).getRegDate() == null ? "대기중" : walist.get(i).getRegDate() );
      out.write("</td>\r\n");
      out.write("\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t\t\t<td>");
      out.print( wlist.get(i).getState() );
      out.write("</td>\r\n");
      out.write("\t\t\t");
