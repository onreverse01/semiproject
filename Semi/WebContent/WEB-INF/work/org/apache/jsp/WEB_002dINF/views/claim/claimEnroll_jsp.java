 ...
 * Generated at: 2021-04-27 09:39:44 UTC
...
public final class claimEnroll_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(loginMember==null){
      ...
      out.print(request.getContextPath());
      out.write("/css/claim.css\">\r\n");
      out.write("  <div class=\"claimfrm\">\r\n");
      out.write("    <div class=\"menubar\">\r\n");
      out.write("        <ul>FAQ\r\n");
      out.write("            <hr>\r\n");
      out.write("            <li><a href=\"#\">모임관련</a></li>\r\n");
      out.write("            <li><a href=\"#\">회원관련</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("        <ul>문의하기\r\n");
      out.write("            <hr>\r\n");
      out.write("            <li><a href=\"");
      out.print( request.getContextPath() );
      out.write("/claim/claimEnroll\">1:1 문의</a></li>\r\n");
      out.write("            <li><a href=\"");
      out.print( request.getContextPath() );
      out.write("/claim/claimList\">문의내역</a></li>\r\n");
      out.write("        </ul>\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      out.write("   <form action=\"");
      out.print( request.getContextPath() );
      out.write("/claim/claimEnroll\" id=\"claimBorder\" method=\"GET\">\r\n");
      ...
      out.write("      <label for=\"문의 채널\">문의 채널 : </label>\r\n");
      out.write("      <select name=\"choice\" id=\"claimChoice\">\r\n");
      out.write("        <option value=\"choice\">문의사항선택</option>\r\n");
      out.write("        <option value=\"모임관련\">모임관련문의</option>\r\n");
      out.write("        <option value=\"회원관련\">회원관련문의</option>\r\n");
      ...
      out.write("      <label for=\"문의 제목\">문의 제목 : </label>\r\n");
      out.write("      <input type=\"text\" name=\"title\" id=\"claimTitle\">\r\n");
      out.write("    </div>\r\n");
      out.write("    \r\n");
      out.write("    <br>\r\n");
      out.write("    \r\n");
      out.write("    <div class=\"content\">\r\n");
      out.write("      <label for=\"문의 내용\" class=\"contentLabel\">문의 내용 : </label>\r\n");
      out.write("      <textarea name=\"content\" id=\"claimContent\" cols=\"50\" rows=\"20\"></textarea>\r\n");
      out.write("    </div>\r\n");
      out.write("    \r\n");
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("\t$(\"#claimBorder\").submit(function(){\r\n");
      out.write("\t\tvar $choice = $(\"[name=choice]\").val();\r\n");
      out.write("\t\tvar $title = $(\"[name=title]\").val();\t\r\n");
      out.write("\t\tvar $content = $(\"[name=content]\").val();\t\r\n");
      out.write("\t\tconsole.log($choice);\r\n");
      out.write("\t\tif($choice==\"choice\"){\r\n");
      out.write("\t\t\talert(\"문의사항을 선택해주세요!\");\r\n");
      out.write("\t\t\t$(\"[name=choice]\").focus();\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\telse if(/^.{1,}$/.test($title)==false){\r\n");
      out.write("\t\t\talert(\"제목을 입력해주세요!\");\r\n");
      out.write("\t\t\t$(\"[name=title]\").focus();\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\telse if($content.length==0 || $content==\"<p><br></p>\"){\r\n");
      out.write("\t\t\talert(\"내용을 입력해주세요!\");\r\n");
      out.write("\t\t\t$(\"[name=content]\").focus();\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
