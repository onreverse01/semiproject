 ...
 * Generated at: 2021-04-25 17:42:05 UTC
...
if(loginMember==null){
	...
	if(location.equals("L1")){
      ...
      out.write("\r\n");
      out.write("\t\t\t<h4 class=\"reset\">제목 검색 : ");
      out.print(search );
      out.write("\r\n");
      out.write("\t\t\t<button class=\"resetbtn\" type=\"button\" onclick=\"location.href='");
      out.print(request.getContextPath());
      ...
      out.write("\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t\t\t<h2 class=\"leftATag\">지역</h2>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<ol>\r\n");
      out.write("\t\t\t<li id=\"L0\"><a href=\"");
      out.print(request.getContextPath());
      out.write("/meeting/meetingList?category=");
      out.print(category);
      out.write("&search=");
...
if(loginMember != null){ 
      out.write("\r\n");
      out.write("\t\t\t<div>\r\n");
      out.write("\t\t\t<button type=\"button\" id=\"createMeeting\" onclick=\"createMeeting();\">모임생성</button><br />\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t");
} 
      out.write("\r\n");
...
for(;i<loop;i++) { 
      ...
      out.write("\t\t<input type=\"text\" name=\"\" id=\"searchKeyword2\" placeholder=\"검색할 키워드를 입력하세요!\" onkeyup=\"enterkey2();\"/>\r\n");
 ...
 if(search.length()!=0) {
      ...
      out.write("\t\t\tlocation='L0';\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tvar li = document.querySelector(\"#\"+location);\r\n");
      out.write("\t\tli.classList.add(\"bold\");\r\n");
      out.write("\t});\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("\r\n");
