 ...
 * Generated at: 2021-04-26 08:16:04 UTC
...
if(loginMember==null){
 ...
 for(BoardComment bc : commentList){ 
      ...
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"comment-level1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<sub class=\"comment-writer\">");
      out.print( bc.getWriter()!=null ? bc.getWriter() : "탈퇴회원" );
      out.write("</sub>\r\n");
 ...
 if(removable){ 
      ...
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"comment-level2\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<sub class=\"comment-writer\">");
      out.print( bc.getWriter()!=null ? bc.getWriter() : "탈퇴회원" );
      out.write("</sub>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"comment-content\">");
 ...
 if(editable){
      ...
      out.write("\r\n");
      out.write("\t\r\n");
      out.write("\t//댓글달기 textArea접근시 로그인 여부 판단\r\n");
 ...
 if(loginMember == null){ 
      ...
      out.write("\t\thtml += '<textarea class=\"btn-insert-reply-textarea\" name=\"content\" cols=\"60\" rows=\"2\"></textarea>';\r\n");
      out.write("\t\thtml += '<button type=\"submit\" class=\"btn-insert-reply\" style=\"background-color: #fd9000;; color:white;\">등록</button>';\r\n");
      out.write("\t\thtml += '</form>';\r\n");
      out.write("\t\thtml += \"</td>\";\r\n");
      out.write("\t\thtml += \"</tr>\";\r\n");
      out.write("\t\t\r\n");
